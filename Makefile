#############################################################################
# Makefile for building: lyrabar-qt
# Generated by qmake (2.01a) (Qt 4.8.2) on: to tammikuuta 29 01:16:20 2015
# Project:  Lyrabar-qt.pro
# Template: app
# Command: /usr/bin/qmake-qt4 USE_UPNP=- -o Makefile Lyrabar-qt.pro
#############################################################################
...
CXXFLAGS      = -m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -std=c++0x -O2 -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -IC:/deps/boost_1_52_0 -IC:/deps/db-4.8.30.NC/build_unix -IC:/deps/openssl-1.0.1j/include -IC:/deps/qrencode-3.4.4 -Ic:/deps/secp256k1 -Ic:/deps/gmp-6.0.0 -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /home/user/Lyrabar/src/leveldb/libleveldb.a /home/user/Lyrabar/src/leveldb/libmemenv.a -lrt -LC:/deps/boost_1_52_0/stage/lib -LC:/deps/db-4.8.30.NC/build_unix -LC:/deps/openssl-1.0.1j -LC:/deps/qrencode-3.4.4/.libs -Lc:/deps/gmp-6.0.0/.libs -Lc:/deps/secp256k1/.libs -l secp256k1 -lssl -lcrypto -ldb_cxx -lgmp -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lboost_random -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		src/Lyra2RE/keccak.c build/moc_bitcoingui.cpp \
...
$(TARGET): /home/user/Lyrabar/src/leveldb/libleveldb.a /home/user/Lyrabar/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Lyrabar-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile Lyrabar-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/lyrabar-qt0.9.0.1 || $(MKDIR) build/lyrabar-qt0.9.0.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/lyrabar-qt0.9.0.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_uk.ts build/lyrabar-qt0.9.0.1/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/stealth.h src/Lyra2RE/Lyra2.h src/Lyra2RE/Lyra2RE.h src/Lyra2RE/Sponge.c src/Lyra2RE/sph_blake.h src/Lyra2RE/sph_groestl.h src/Lyra2RE/sph_keccak.h src/Lyra2RE/sph_skein.h src/Lyra2RE/sph_types.h build/lyrabar-qt0.9.0.1/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/lyrabar-qt0.9.0.1/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/stealth.cpp src/Lyra2RE/Lyra2.c src/Lyra2RE/Lyra2RE.c src/Lyra2RE/Sponge.c src/Lyra2RE/blake.c src/Lyra2RE/skein.c src/Lyra2RE/groestl.c src/Lyra2RE/keccak.c build/lyrabar-qt0.9.0.1/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/lyrabar-qt0.9.0.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_uk.ts build/lyrabar-qt0.9.0.1/ && (cd `dirname build/lyrabar-qt0.9.0.1` && $(TAR) lyrabar-qt0.9.0.1.tar lyrabar-qt0.9.0.1 && $(COMPRESS) lyrabar-qt0.9.0.1.tar) && $(MOVE) `dirname build/lyrabar-qt0.9.0.1`/lyrabar-qt0.9.0.1.tar.gz . && $(DEL_FILE) -r build/lyrabar-qt0.9.0.1


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/user/Lyrabar/src/leveldb/libleveldb.a; cd /home/user/Lyrabar/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/user/Lyrabar/src/leveldb/libleveldb.a: FORCE
	cd /home/user/Lyrabar/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -std=c++0x -O2" libleveldb.a libmemenv.a

/home/user/Lyrabar/build/build.h: FORCE
	cd /home/user/Lyrabar; /bin/sh share/genbuild.sh /home/user/Lyrabar/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/bitcoin_en.qm src/qt/locale/bitcoin_fi.qm src/qt/locale/bitcoin_ru.qm src/qt/locale/bitcoin_uk.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/bitcoin_en.qm src/qt/locale/bitcoin_fi.qm src/qt/locale/bitcoin_ru.qm src/qt/locale/bitcoin_uk.qm
...
build/Lyra2.o: src/Lyra2RE/Lyra2.c src/Lyra2RE/Lyra2.h \
		src/Lyra2RE/Sponge.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/Lyra2.o src/Lyra2RE/Lyra2.c

build/Lyra2RE.o: src/Lyra2RE/Lyra2RE.c src/Lyra2RE/Lyra2RE.h \
		...
		src/Lyra2RE/Lyra2.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/Lyra2RE.o src/Lyra2RE/Lyra2RE.c

build/Sponge.o: src/Lyra2RE/Sponge.c src/Lyra2RE/Sponge.h \
		src/Lyra2RE/Lyra2.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/Sponge.o src/Lyra2RE/Sponge.c

build/blake.o: src/Lyra2RE/blake.c src/Lyra2RE/sph_blake.h \
		src/Lyra2RE/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/blake.o src/Lyra2RE/blake.c

build/skein.o: src/Lyra2RE/skein.c src/Lyra2RE/sph_skein.h \
		src/Lyra2RE/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/skein.o src/Lyra2RE/skein.c

build/groestl.o: src/Lyra2RE/groestl.c src/Lyra2RE/sph_groestl.h \
		src/Lyra2RE/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/groestl.o src/Lyra2RE/groestl.c

build/keccak.o: src/Lyra2RE/keccak.c src/Lyra2RE/sph_keccak.h \
		src/Lyra2RE/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/keccak.o src/Lyra2RE/keccak.c
