...
# Template: app
# Command: C:\Qt\5.3.2\bin\qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile Lyrabar-qt.pro
#############################################################################
...
Makefile: Lyrabar-qt.pro ../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../Qt/5.3.2/mkspecs/features/spec_pre.prf \
		...
		../Qt/5.3.2/mkspecs/modules-inst/qt_lib_designer.pri \
		../Qt/5.3.2/mkspecs/modules-inst/qt_lib_designer_private.pri \
		../Qt/5.3.2/mkspecs/modules/qt_lib_designer.pri \
		../Qt/5.3.2/mkspecs/modules-inst/qt_lib_designercomponents_private.pri \
		../Qt/5.3.2/mkspecs/modules/qt_lib_designercomponents_private.pri \
		...
		../Qt/5.3.2/mkspecs/modules/qt_tool_qcollectiongenerator.pri \
		../Qt/5.3.2/mkspecs/modules/qt_tool_qdoc.pri \
		../Qt/5.3.2/mkspecs/modules/qt_tool_qhelpgenerator.pri \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile Lyrabar-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:\Lyrabar\src\leveldb\libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:\Lyrabar\src\leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\Lyrabar\lyrabar-qt_plugin_import.cpp

C:/Lyrabar/src/leveldb/libleveldb.a: FORCE
