...
{
    return GetBoolArg("-testnet", false) ? 14047 : 4047; // Testnet / Mainnet RPC Port
}
...
int64 AmountFromValue(const Value& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 1149750.0)
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Lyrabar server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: lyrabar-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use lyrabard";
