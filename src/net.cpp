...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Lyrabar " + FormatFullVersion();
        ...
        try {
            loop {
                ...
                MilliSleep(15*60*1000); // Refresh every 15 minutes
            }
        }
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Lyrabar is probably already running."), addrBind.ToString().c_str());
        else
